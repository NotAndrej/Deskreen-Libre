export enum IpcEvents {
	...
	GetAutoStartOnLogin = 'get-auto-start-on-login',
	SetAutoStartOnLogin = 'set-auto-start-on-login',
	GetPreventAccidentalQuit = 'get-prevent-accidental-quit',
	SetPreventAccidentalQuit = 'set-prevent-accidental-quit',
	GetCustomServerPort = 'get-custom-server-port',
	SetCustomServerPort = 'set-custom-server-port',
